...
export function setUserBalance(state:DposState, payload:{}|any) {
...
export function setRewardsResults(state:DposState, payload:string|any) {
...
export function setSelectedAccount(state:DposState, payload) {
...
export function setSelectedLedgerPath(state:DposState, payload) {
...
export function setAnalyticsData(state:DposState, payload:{}|any) {
